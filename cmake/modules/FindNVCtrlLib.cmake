...
if (NVCtrlLib_FOUND)
    ...
    FIND_PACKAGE_MESSAGE(NVCtrlLib "Found NVCtrlLib: ${NVCtrlLib_LIBRARY}"
        "[${NVCtrlLib_LIBRARY}][${NVCtrlLib_INCLUDE_DIR}]")
else()
    if (NVCtrlLib_FIND_REQUIRED)
        message(FATAL_ERROR "Could not find NVCtrlLib")
    endif()
endif()
